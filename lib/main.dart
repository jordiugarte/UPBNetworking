...
class InitialPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    PrimaryButton loginButton = new PrimaryButton("Iniciar Sesión", ButtonAction.GO_TO_PAGE);
    PrimaryButton registerButton = new PrimaryButton("Registrarse", ButtonAction.GO_TO_PAGE);
